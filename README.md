...
The purpose of this project is to collect raw dataset and make it tidy data by merging raw table, subset and rename column.
...
Here are the data for the project (Raw Zip Data):
